...
export const VanillaContractArtifact = loadContractArtifact(
  VanillaContractArtifactJson as NoirCompiledContract,
);
...
export class VanillaContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      VanillaContract.artifact,
      wallet,
    ) as Promise<VanillaContract>;
  }
  ...
  public static deploy(
    ...
    return new DeployMethod<VanillaContract>(
      Point.ZERO,
      wallet,
      VanillaContractArtifact,
      VanillaContract.at,
  ...
  public methods!: {
    ...
    getNumber: ((owner: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">;
  };
}
