...
export const BoxReactContractArtifact = loadContractArtifact(
  BoxReactContractArtifactJson as NoirCompiledContract,
);
...
export class BoxReactContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      BoxReactContract.artifact,
      wallet,
    ) as Promise<BoxReactContract>;
  }
